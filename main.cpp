...
void main()
{
	...
	cfg.Construct_primary(K2200_portIndex, status);
}
...
NvAPI_Status SetMode(void)
{
	...
	//printf("Force Display resolution to 1024x 768, press any key to continue");
	//getchar();
	//pathInfo[0].sourceModeInfo->resolution = NV_RESOLUTION{ 1024,768 };
